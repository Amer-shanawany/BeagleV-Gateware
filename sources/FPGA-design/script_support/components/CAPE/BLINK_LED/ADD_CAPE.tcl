puts "======== Add cape option: BLINK_LED ========"

#-------------------------------------------------------------------------------
# Import HDL source files
#-------------------------------------------------------------------------------
import_files -hdl_source {script_support/components/CAPE/BLINK_LED/HDL/apb_ctrl_status.v}
import_files -hdl_source {script_support/components/CAPE/BLINK_LED/HDL/blink_led.vhd}
import_files -hdl_source {script_support/components/CAPE/BLINK_LED/HDL/P8_IOPADS.v}
import_files -hdl_source {script_support/components/CAPE/BLINK_LED/HDL/P9_11_18_IOPADS.v}
import_files -hdl_source {script_support/components/CAPE/BLINK_LED/HDL/P9_21_31_IOPADS.v}
import_files -hdl_source {script_support/components/CAPE/BLINK_LED/HDL/P9_41_42_IOPADS.v}
import_files -hdl_source {script_support/components/CAPE/BLINK_LED/HDL/CAPE.v}
